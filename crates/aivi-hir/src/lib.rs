...
pub use hir::{
    ...
    Decorator, DecoratorCall, DecoratorPayload, DeprecatedDecorator, DeprecationNotice,
    DomainItem, DomainMember, DomainMemberHandle, DomainMemberKind, DomainMemberResolution,
    EachControl, EmptyControl, ExportItem, ExportResolution, Expr, ExprKind, FloatLiteral,
    FragmentControl, FunctionItem, FunctionParameter, ImportBinding, ImportBindingMetadata,
    ImportBindingResolution, ImportBundleKind, ImportRecordField, ImportValueType, InstanceItem,
    InstanceMember, IntegerLiteral, IntrinsicValue, Item, ItemHeader, ItemKind,
    LiteralSuffixResolution, MapExpr, MapExprEntry, MarkupAttribute, MarkupAttributeValue,
    MarkupElement, MarkupNode, MarkupNodeKind, MatchControl, MockDecorator, Module,
    ...
    PipeTransformMode, ProjectionBase, RecordExpr, RecordExprField, RecordFieldSurface,
