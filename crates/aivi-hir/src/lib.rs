...
pub use hir::{
    ...
    PipeCaseStageRun, PipeExpr, PipeFanoutSegment, PipeRecurrenceShapeError, PipeRecurrenceSuffix,
    PipeSemanticStage, PipeStage, PipeStageKind, PipeSubjectStage, PipeTransformMode,
    PipeTruthyFalsyPair, ProjectionBase, ReactiveUpdateBodyMode, ReactiveUpdateClause, RecordExpr,
